...
if CLIENT then
	...
	SWEP.ShowWorldModel = false	
		SWEP.VElements = {
			["circle1"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-1.388, 0.05, 6.684), angle = Angle(54, 0, 0), size = Vector(0.004, 0.011, 0.007), color = Color(0, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
			["circle2"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-1.525, 0.05, 6.502), angle = Angle(54, 0, 0), size = Vector(0.004, 0.011, 0.005), color = Color(0, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
			["circle3"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-1.664, 0.05, 6.3), angle = Angle(54, 0, 0), size = Vector(0.004, 0.011, 0.005), color = Color(0, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
			["jar1"] = { type = "Model", model = "models/props_lab/jar01a.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "Рукоять1", pos = Vector(-1.487, 0.05, 6.538), angle = Angle(-36, 0, 0), size = Vector(0.002, 0.072, 0.062), color = Color(86, 211, 217, 255), surpresslightning = true, material = "phoenix_storms/Fender_white", skin = 0, bodygroup = {} },
			["something_i_don't_know_about1"] = { type = "Model", model = "models/props_phx/construct/metal_wire1x2b.mdl", bone = "Python", rel = "", pos = Vector(-0.1, 1.362, 5.785), angle = Angle(0, 0, 0), size = Vector(0.023, 0.036, 0.039), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["something_i_don't_know_about1+"] = { type = "Model", model = "models/hunter/plates/plate1x2.mdl", bone = "Python", rel = "something_i_don't_know_about1", pos = Vector(0, -0.819, 0.08), angle = Angle(0, 0, 0), size = Vector(0.018, 0.032, 0.021), color = Color(86, 211, 217, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Дуло"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(6.29614, 0.04407, 5.01301), angle = Angle(0, 0, 89.99991), size = Vector(0.127, 0.072, 0.361), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло+"] = { type = "Model", model = "models/mechanics/robotics/d3.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(4.06042, 0.05006, 6.59898), angle = Angle(0, 0, 89.99973), size = Vector(0.073, 0.073, 0.093), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло++"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(3.45746, 0.05006, 5.549), angle = Angle(0, 89.99979, -89.99993), size = Vector(0.028, 0.049, 0.115), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло+++"] = { type = "Model", model = "models/hunter/tubes/circle2x2d.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(3.28479, 0.05005, 3.79099), angle = Angle(0, 180, -89.99994), size = Vector(0.018, 0.014, 0.443), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло++++"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(5.89398, 0.05006, 3.60296), angle = Angle(0, -89.99992, 0), size = Vector(0.028, 0.11, 0.141), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло+++++"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(5.43182, 0.05, 6.23499), angle = Angle(-89.99986, -89.99994, 0), size = Vector(0.021, 0.113, 0.378), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло++++++"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(4.41064, 0.05, 5.378), angle = Angle(-89.99986, -89.99994, 0), size = Vector(0.016, 0.07, 0.378), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло+++++++"] = { type = "Model", model = "models/hunter/triangles/1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(6.48981, 0.05, 5.378), angle = Angle(89.99985, -89.99997, 0), size = Vector(0.016, 0.018, 0.378), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло++++++++"] = { type = "Model", model = "models/hunter/geometric/hex05x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(6.07385, -0.52, 4.58499), angle = Angle(0, -89.99994, 89.99999), size = Vector(0.002, 0.009, 0.875), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло+++++++++"] = { type = "Model", model = "models/hunter/geometric/hex05x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(3.45404, 0.60505, 4.585), angle = Angle(0, 89.99992, 89.99995), size = Vector(0.002, 0.009, 0.875), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло++++++++++"] = { type = "Model", model = "models/hunter/misc/squarecap2x1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(3.45386, 0.05006, 6.97098), angle = Angle(0, 0, 0), size = Vector(0.007, 0.014, 0.011), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло+++++++++++"] = { type = "Model", model = "models/props_phx/misc/iron_beam1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(1.45679, 0.05001, 6.77399), angle = Angle(0, 0, 0), size = Vector(0.085, 0.057, 0.036), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло++++++++++++"] = { type = "Model", model = "models/hunter/blocks/cube075x075x075.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(7.91382, 0.05001, 6.879), angle = Angle(0, -89.99994, 0), size = Vector(0.031, 0.011, 0.009), color = Color(255, 255, 255, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Основание1"] = { type = "Model", model = "models/hunter/triangles/025x025.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-2.18835, 0, 6.79298), angle = Angle(0, 0, 89.99991), size = Vector(0.145, 0.167, 0.333), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Основание1++"] = { type = "Model", model = "models/props_junk/propane_tank001a.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-1.62823, 0.05, 5.41198), angle = Angle(0, -89.99994, 89.99999), size = Vector(0.08, 0.08, 0.055), color = Color(255, 255, 255, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Основание1+++"] = { type = "Model", model = "models/hunter/plates/plate075x075.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-1.50916, -0.12601, 6.32), angle = Angle(-53.99997, -180, 180), size = Vector(0.031, 0.026, 0.059), color = Color(0, 0, 0, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Основание1++++"] = { type = "Model", model = "models/hunter/plates/plate075x075.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-1.21497, -0.12601, 6.08797), angle = Angle(-53.99997, -180, 180), size = Vector(0.033, 0.027, 0.242), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Основание2"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet4", rel = "", pos = Vector(0, 0, -2.33093), angle = Angle(-89.99999, -1e-05, 0), size = Vector(0.025, 0.058, 0.055), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
			["Основание2++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Cylinder", rel = "", pos = Vector(0, 0, -2.482), angle = Angle(-90, 0, 0), size = Vector(0.126, 0.192, 0.192), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Основание2+++"] = { type = "Model", model = "models/hunter/tubes/circle2x2.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-0.37219, 7e-05, 5.792), angle = Angle(89.99992, 0, 0), size = Vector(0.022, 0.016, 0.073), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Основание2++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet4", rel = "Основание2", pos = Vector(0.317, 0, 0), angle = Angle(90, 0, 0), size = Vector(0.016, 0.016, 0.016), color = Color(86, 211, 217, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Основание2+++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet3", rel = "Основание2++++++++", pos = Vector(-0.32, 0, 0), angle = Angle(-90, 0, 0), size = Vector(0.016, 0.016, 0.016), color = Color(86, 211, 217, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Основание2++++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet2", rel = "Основание2+++++++", pos = Vector(-0.228, 0, 0), angle = Angle(0, -90, 90), size = Vector(0.016, 0.016, 0.016), color = Color(86, 211, 217, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Основание2+++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet2", rel = "", pos = Vector(0, 0, -2.33093), angle = Angle(89.99999, 0, 0), size = Vector(0.025, 0.058, 0.055), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
			["Основание2++++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet3", rel = "", pos = Vector(0, 1e-05, -2.33093), angle = Angle(89.99999, 0, 0), size = Vector(0.025, 0.058, 0.055), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
			["Основание2+++++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet1", rel = "", pos = Vector(0, -1e-05, -2.33093), angle = Angle(-89.99997, 88.99999, 0), size = Vector(0.025, 0.058, 0.055), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
			["Основание2++++++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet6", rel = "", pos = Vector(0, 0, -2.331), angle = Angle(-90, 90, 0), size = Vector(0.025, 0.058, 0.055), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
			["Основание2+++++++++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet1", rel = "Основание2+++++++++", pos = Vector(0.32, 0, 0), angle = Angle(90, 0, 0), size = Vector(0.016, 0.016, 0.016), color = Color(86, 211, 217, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Основание2++++++++++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet6", rel = "Основание2++++++++++", pos = Vector(0.317, 0, 0), angle = Angle(90, 0, 0), size = Vector(0.016, 0.016, 0.016), color = Color(86, 211, 217, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Основание2+++++++++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet5", rel = "", pos = Vector(0, 0, -2.331), angle = Angle(-90, 89, 0), size = Vector(0.025, 0.058, 0.055), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
			["Основание2++++++++++++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet1", rel = "Основание2+++++++++++++", pos = Vector(0.331, 0, 0), angle = Angle(90, 0, 0), size = Vector(0.016, 0.016, 0.016), color = Color(86, 211, 217, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Прицел1"] = { type = "Model", model = "models/hunter/triangles/trapezium3x3x1c.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(8.59265, 0.05012, 7.04099), angle = Angle(0, 0, 0), size = Vector(0.019, 0.023, 0.015), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Прицел1+"] = { type = "Model", model = "models/hunter/triangles/1x1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-0.19751, -0.38994, 7.04002), angle = Angle(0, 0, 0), size = Vector(0.013, 0.007, 0.015), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Прицел1++"] = { type = "Model", model = "models/hunter/triangles/1x1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-0.19623, 0.498, 7.03999), angle = Angle(0, -180, 0), size = Vector(0.013, 0.007, 0.015), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Рукоять1"] = { type = "Model", model = "models/weapons/w_pist_deagle.mdl", bone = "Python", rel = "", pos = Vector(2.29276, 6.16434, -3.49423), angle = Angle(90, -90, 0), size = Vector(0.954, 0.848, 0.982), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} }
		}
		SWEP.WElements = {
			...
			["jar1"] = { type = "Model", model = "models/props_lab/jar01a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(-1.487, 0.04999, 6.53799), angle = Angle(-35.99999, 0, 0), size = Vector(0.002, 0.072, 0.062), color = Color(86, 211, 217, 255), surpresslightning = true, material = "phoenix_storms/Fender_white", skin = 0, bodygroup = {} },
			["something_i_don't_know_about1"] = { type = "Model", model = "models/props_phx/construct/metal_wire1x2b.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(9.276, 0.05, 4.157), angle = Angle(0, 90, 90), size = Vector(0.023, 0.036, 0.039), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["something_i_don't_know_about1+"] = { type = "Model", model = "models/hunter/plates/plate1x2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "something_i_don't_know_about1", pos = Vector(0, -0.819, 0.08), angle = Angle(0, 0, 0), size = Vector(0.018, 0.032, 0.021), color = Color(86, 211, 217, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Дуло"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(6.29599, 0.04401, 5.01299), angle = Angle(0, 0, 89.99999), size = Vector(0.127, 0.072, 0.361), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло+"] = { type = "Model", model = "models/mechanics/robotics/d3.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(4.06, 0.05005, 6.59899), angle = Angle(0, 0, 89.99999), size = Vector(0.073, 0.073, 0.093), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло++"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(3.45699, 0.04999, 5.549), angle = Angle(0, 90.00001, -89.99998), size = Vector(0.028, 0.049, 0.115), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло+++"] = { type = "Model", model = "models/hunter/tubes/circle2x2d.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(3.28499, 0.04999, 3.79099), angle = Angle(0, -180, -89.99999), size = Vector(0.018, 0.014, 0.443), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло++++"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(5.89398, 0.05005, 3.603), angle = Angle(0, -90.00001, -1e-05), size = Vector(0.028, 0.11, 0.141), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло+++++"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(5.43199, 0.05011, 6.235), angle = Angle(-89.99999, -90.00001, 0), size = Vector(0.021, 0.113, 0.378), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло++++++"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(4.41098, 0.05005, 5.378), angle = Angle(-89.99999, -90.00001, 0), size = Vector(0.016, 0.07, 0.378), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло+++++++"] = { type = "Model", model = "models/hunter/triangles/1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(6.48999, 0.04999, 5.37799), angle = Angle(89.99999, -90.00002, 0), size = Vector(0.016, 0.018, 0.378), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло++++++++"] = { type = "Model", model = "models/hunter/geometric/hex05x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(6.07401, -0.52002, 4.585), angle = Angle(0, -90.00001, 89.99997), size = Vector(0.002, 0.009, 0.875), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло+++++++++"] = { type = "Model", model = "models/hunter/geometric/hex05x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(3.45399, 0.60498, 4.585), angle = Angle(0, 90.00001, 90), size = Vector(0.002, 0.009, 0.875), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Дуло++++++++++"] = { type = "Model", model = "models/hunter/misc/squarecap2x1x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(3.45399, 0.05011, 6.97099), angle = Angle(0, 0, 0), size = Vector(0.007, 0.014, 0.011), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло+++++++++++"] = { type = "Model", model = "models/props_phx/misc/iron_beam1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(1.45699, 0.05005, 6.77399), angle = Angle(0, 0, 0), size = Vector(0.085, 0.057, 0.036), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Дуло++++++++++++"] = { type = "Model", model = "models/hunter/blocks/cube075x075x075.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(7.91399, 0.05005, 6.87899), angle = Angle(0, -90.00001, -1e-05), size = Vector(0.031, 0.011, 0.009), color = Color(255, 255, 255, 255), surpresslightning = false, material = "phoenix_storms/gear", skin = 0, bodygroup = {} },
			["Основание1"] = { type = "Model", model = "models/hunter/triangles/025x025.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(-2.18802, 0, 6.79299), angle = Angle(0, 0, 89.99999), size = Vector(0.145, 0.167, 0.333), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Основание1++"] = { type = "Model", model = "models/props_junk/propane_tank001a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(-1.62801, 0.04999, 5.41199), angle = Angle(0, -90.00001, 89.99997), size = Vector(0.08, 0.08, 0.055), color = Color(255, 255, 255, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Основание1+++"] = { type = "Model", model = "models/hunter/plates/plate075x075.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(-1.50902, -0.12604, 6.31999), angle = Angle(-53.99996, 180, 180), size = Vector(0.031, 0.026, 0.059), color = Color(0, 0, 0, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
			["Основание1++++"] = { type = "Model", model = "models/hunter/plates/plate075x075.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(-1.21501, -0.12598, 6.088), angle = Angle(-53.99996, 180, 180), size = Vector(0.033, 0.027, 0.242), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Основание2+++"] = { type = "Model", model = "models/hunter/tubes/circle2x2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(-0.37201, 0, 5.79199), angle = Angle(89.99998, 0, 0), size = Vector(0.022, 0.016, 0.073), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
			["Прицел1"] = { type = "Model", model = "models/hunter/triangles/trapezium3x3x1c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "Рукоять1", pos = Vector(8.59299, 0.05005, 7.04099), angle = Angle(0, 0, 0), size = Vector(0.019, 0.023, 0.015), color = Color(169, 163, 147, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
	...
	function SWEP:PostDrawViewModel(vm, pl, wep)
		...
		local col1 = Color(155 * self:GetChargePerc() , 255 / 155 * self:GetChargePerc(), 0)
		veles["circle1"].color = col1
		veles["circle2"].color = col1
		veles["circle3"].color = col1
	end
...
function SWEP:Think()
	...
	if owner:IsPlayer() and owner.ClanQuePro then
		self.OldW = self.WElements
		self.OldV = self.VElements
		self.WElements = self.WElements2
		self.VElements = self.VElements2
		
	elseif owner:IsPlayer() and !owner.ClanQuePro then
		self.OldW = self.WElements
		self.OldV = self.VElements
		self.WElements = self.OldW
		self.VElements = self.OldV
	end
