AddCSLuaFile()
SWEP.PrintName = translate.Get("wep_shield")
SWEP.Description = translate.Get("wep_d_shield")
...
if CLIENT then
	...
	SWEP.VElements = {
		...
		["e1+++"] = { type = "Model", model = "models/hunter/triangles/025x025.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(-3.119, 17.154, -3.391), angle = Angle(0, 90, -180), size = Vector(0.483, 0.345, 0.631), color = Color(0, 100, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
		["e1++++"] = { type = "Model", model = "models/hunter/triangles/025x025.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(3.047, 17.154, -3.39), angle = Angle(0, 0, 180), size = Vector(0.344, 0.483, 0.631), color = Color(0, 100, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
		["e1+++++"] = { type = "Model", model = "models/hunter/geometric/hex025x1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(0.015, 14.711, -2.442), angle = Angle(0, 0, 180), size = Vector(0.173, 0.231, 0.631), color = Color(0, 100, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
		...
		["e1+++++++"] = { type = "Model", model = "models/hunter/misc/roundthing2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(0, -1.485, -4.337), angle = Angle(0, 0, 0), size = Vector(0.339, 0.23, 0.04), color = Color(0, 100, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	...
	["e1+"] = { type = "Model", model = "models/props_lab/pipesystem03c.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(0, 0, 1.753), angle = Angle(0, 0, 0), size = Vector(1.31, 2.079, 1.31), color = Color(255, 255, 255, 255), surpresslightning = false, material = "phoenix_storms/concrete0", skin = 0, bodygroup = {} },
	["e1+++"] = { type = "Model", model = "models/hunter/triangles/025x025.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(-5.065, 15.191, -3.391), angle = Angle(0, 90, -180), size = Vector(0.635, 0.395, 0.631), color = Color(0, 100, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
	["e1++++"] = { type = "Model", model = "models/hunter/triangles/025x025.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(5.114, 15.153, -3.39), angle = Angle(0, 0, 180), size = Vector(0.395, 0.635, 0.631), color = Color(0, 100, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
	...
	["e1+++++++"] = { type = "Model", model = "models/hunter/misc/roundthing2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(0, -2.158, -4.337), angle = Angle(0, 0, 0), size = Vector(0.42, 0.229, 0.04), color = Color(0, 100, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
	...
	["e1++++++++++"] = { type = "Model", model = "models/hunter/tubes/circle2x2d.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(0.15, 3.494, -6.443), angle = Angle(-7.706, 0.352, -176.384), size = Vector(0.214, 0.457, 0.45), color = Color(0, 104, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
	...
	["e1++++++++++++"] = { type = "Model", model = "models/hunter/tubes/circle2x2d.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(-0.2, 3.494, -6.443), angle = Angle(-9.204, -180, -4), size = Vector(0.214, 0.457, 0.45), color = Color(0, 104, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
	["e1+++++++++++++"] = { type = "Model", model = "models/hunter/tubes/circle2x2d.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(-0.037, 3.249, -6.312), angle = Angle(-6.862, 0.664, -8.642), size = Vector(0.213, 0.24, 0.55), color = Color(0, 104, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
	["e1++++++++++++++"] = { type = "Model", model = "models/hunter/tubes/circle2x2d.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "e1", pos = Vector(-0.032, 3.286, -6.263), angle = Angle(-9.087, 179.638, -171.201), size = Vector(0.213, 0.24, 0.55), color = Color(0, 104, 194, 255), surpresslightning = false, material = "phoenix_storms/mat/mat_phx_metallic", skin = 0, bodygroup = {} },
