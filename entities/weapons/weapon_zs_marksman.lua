...
SWEP.VElements = {
	["something_i_don't_know_about1"] = { type = "Model", model = "models/props_phx/construct/metal_wire1x2b.mdl", bone = "Python", rel = "", pos = Vector(-0.062, 1.362, 5.785), angle = Angle(0, 0, 0), size = Vector(0.024, 0.036, 0.038), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
	["something_i_don't_know_about1+"] = { type = "Model", model = "models/hunter/plates/plate1x2.mdl", bone = "Python", rel = "something_i_don't_know_about1", pos = Vector(0, -0.819, 0.08), angle = Angle(0, 0, 0), size = Vector(0.018, 0.032, 0.021), color = Color(120, 255, 243, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["something_i_don't_know_about1++"] = { type = "Model", model = "models/props_phx/construct/metal_wire1x2b.mdl", bone = "Python", rel = "", pos = Vector(-0.062, 1.362, 5.785), angle = Angle(0, 0, 0), size = Vector(0.024, 0.036, 0.038), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
	...
	["Основание2"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet4", rel = "Основание2++++", pos = Vector(0, 0, 0.317), angle = Angle(-90, 0, 0), size = Vector(0.025, 0.058, 0.055), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
	["Основание2++"] = { type = "Model", model = "models/valgaming/weapons/sw500_cylinder.mdl", bone = "Cylinder_release", rel = "", pos = Vector(0, -1.434, -4.542), angle = Angle(0, -57.032, -90), size = Vector(1.455, 1.226, 1.455), color = Color(150, 150, 150, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	...
	["Основание2++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet4", rel = "", pos = Vector(-0.235, 0.025, -2.573), angle = Angle(0, 0, 0), size = Vector(0.016, 0.016, 0.016), color = Color(0, 242, 255, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["Основание2+++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet3", rel = "", pos = Vector(0, 0.075, -2.651), angle = Angle(0, 0, 0), size = Vector(0.016, 0.016, 0.016), color = Color(0, 242, 255, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["Основание2++++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet2", rel = "Основание2+++++++", pos = Vector(-0.228, 0, 0), angle = Angle(0, -90, 90), size = Vector(0.016, 0.016, 0.016), color = Color(0, 242, 255, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["Основание2+++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet2", rel = "", pos = Vector(0.004, -0.036, -2.274), angle = Angle(90, 0, 0), size = Vector(0.025, 0.058, 0.055), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
	["Основание2++++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet3", rel = "Основание2+++++", pos = Vector(0, 0, 0.32), angle = Angle(90, 0, 0), size = Vector(0.025, 0.058, 0.055), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
	["Основание2+++++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet1", rel = "Основание2+++++++++++", pos = Vector(0, 0, 0.32), angle = Angle(-90, 0, 0), size = Vector(0.025, 0.058, 0.055), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
	["Основание2++++++++++"] = { type = "Model", model = "models/mechanics/robotics/a1.mdl", bone = "Bullet6", rel = "Основание2++++++++++++", pos = Vector(0, 0, 0.317), angle = Angle(-90, 0, 0), size = Vector(0.025, 0.058, 0.055), color = Color(210, 210, 210, 255), surpresslightning = false, material = "phoenix_storms/concrete1", skin = 0, bodygroup = {} },
	["Основание2+++++++++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet1", rel = "", pos = Vector(-0.181, 0.039, -2.462), angle = Angle(0, 89, 0), size = Vector(0.016, 0.016, 0.016), color = Color(0, 242, 255, 255), surpresslightning = false, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["Основание2++++++++++++"] = { type = "Model", model = "models/props_phx/wheels/wooden_wheel1.mdl", bone = "Bullet6", rel = "", pos = Vector(-0.108, 0.326, -2.761), angle = Angle(0, 90, 0), size = Vector(0.016, 0.016, 0.016), color = Color(0, 242, 255, 255), surpresslightning = true, material = "models/debug/debugwhite", skin = 0, bodygroup = {} },
	["Прицел1"] = { type = "Model", model = "models/hunter/triangles/trapezium3x3x1c.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(8.539, 0, 7.041), angle = Angle(0, 0, 0), size = Vector(0.016, 0.02, 0.015), color = Color(208, 208, 208, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
	["Прицел1+"] = { type = "Model", model = "models/hunter/triangles/1x1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-0.197, -0.393, 7.04), angle = Angle(0, 0, 0), size = Vector(0.013, 0.007, 0.015), color = Color(208, 208, 208, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
	["Прицел1++"] = { type = "Model", model = "models/hunter/triangles/1x1x1.mdl", bone = "Python", rel = "Рукоять1", pos = Vector(-0.196, 0.48, 7.04), angle = Angle(0, -180, 0), size = Vector(0.013, 0.009, 0.015), color = Color(208, 208, 208, 255), surpresslightning = false, material = "phoenix_storms/metal_plate", skin = 0, bodygroup = {} },
	["Рукоять1"] = { type = "Model", model = "models/weapons/w_pist_deagle.mdl", bone = "Python", rel = "", pos = Vector(0, 5.519, -3.49), angle = Angle(90, -90, 0), size = Vector(0.954, 0.848, 0.982), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
