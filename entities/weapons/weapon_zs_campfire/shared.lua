SWEP.PrintName = translate.Get("wep_campfire")
SWEP.Description = translate.Get("wep_d_campfire")
...
SWEP.GhostStatus = "ghost_campfire"
SWEP.DeployClass = "prop_campfire"
