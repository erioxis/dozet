...
function SWEP:PrimaryAttack(right, sec)
	...
	owner:EmitSound( (sec and Sound("zombiesurvival/mp_judgement"..(math.random(1,2) == 2 and 2 or "")..".ogg") or Sound("zombiesurvival/Mp_die"..(math.random(1,2) == 2 and 2 or "")..".ogg")),560,2000,2000)
...
function SWEP:DealDamage()
	...
	if hitent:IsValid() then
		...
		if anim == "fists_uppercut" then
			...
			if hitent:IsValid() then
				hitent.DMGForSlime = (hitent.DMGForSlime or 1) + 0.15
				damagemultiplier = damagemultiplier * hitent.DMGForSlime
		...
		if hitent:IsPlayer() then
			...
			if hitent:Health() <= damage then
				hitent:EmitSound(Sound("zombiesurvival/mp_weak.ogg"),560,2000,2000)
				owner:EmitSound(Sound("zombiesurvival/mp_weak.ogg"),560,2000,2000)
			else
				rand = math.random(1,2)
				hitent:EmitSound(Sound("zombiesurvival/mp_thyend"..(rand == 2 and 2 or "")..".ogg"),120,1500,2000)
				owner:EmitSound(Sound("zombiesurvival/mp_thyend"..(rand == 2 and 2 or "").."ogg"),120,1500,2000)
			end
			if SERVER then
