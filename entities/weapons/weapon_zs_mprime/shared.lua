...
SWEP.PrintName = "FISTS FOR JUDGE!"
	...
	if hitent:IsValid() then
		...
		if hitent:IsPlayer() then
			...
			if hitent:Health() <= damage then
				...
				hitent:EmitSound(Sound("zombiesurvival/mp_thyend"..(rand == 2 and 2 or "")..".ogg"))
				owner:EmitSound(Sound("zombiesurvival/mp_thyend"..(rand == 2 and 2 or "").."ogg"))
			end
			if SERVER then
