...
function ENT:Draw()
	...
	local a = math.abs(math.sin(curtime)) * math.Rand(2,2.05)
	local hscale = 0.2 + a * 0.04
	...
	render.SetColorModulation(0.282, 0.039, 0.039)
	...
	for i=0, math.random(1, 15) do
		...
		particle:SetVelocity(Angle(math.Rand(-85, -70), math.Rand(0, 360), 0):Forward() * math.Rand(100, 500))
