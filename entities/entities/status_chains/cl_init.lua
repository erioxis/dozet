...
function ENT:Draw()
	...
	if not owner:IsValid() or owner == MySelf and not owner:ShouldDrawLocalPlayer() or !who:IsValid() or !who:IsPlayer() or who == owner or who:Team() ~= owner:Team() then return end
