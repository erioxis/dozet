...
function ENT:Think()
	...
	local dmg = (lox and math.Clamp(owner:GetMaxHealth() / (owner:Team() == TEAM_HUMAN and 35 or 150) * 2, 2, 100) or math.Clamp(owner:GetMaxHealth() / (owner:Team() == TEAM_HUMAN and 35 or 150), 1, 50))
