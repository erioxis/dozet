...
function ENT:GiveToActivator(activator, caller)
	...
	if itypecat == INVCAT_TRINKETS and (activator:HasInventoryItem(itype) or activator:HasInventoryItemQ(itype) or activator:HasInventoryItem(string.sub(itype,0,#itype-3))) and !( GAMEMODE.ZSInventoryItemData[itype].OnlyDrones or GAMEMODE.ZSInventoryItemData[itype].Stackable)  then
