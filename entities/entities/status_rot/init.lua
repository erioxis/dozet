...
function ENT:Think()
	...
	if owner:IsValid() then
		owner:TakeDamage(owner:GetMaxHealth()*0.015 *(owner:HasTrinket("bloodgrass") and self.NoDamage and 0 or 1), self.Damager and self.Damager:IsValid() and self.Damager:IsPlayer() and self.Damager or owner, self)
