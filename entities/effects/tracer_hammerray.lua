...
function EFFECT:Render()
	...
	for i = 0, 4 do
		render.DrawBeam(self.StartPos, cubicone, 6, texcoord, texcoord + nlen / 128, Color(226, 196, 25, 255 * alpha))
		render.DrawBeam(cubicone, cubictwo, 6, texcoord, texcoord + nlen / 128, Color(226, 196, 25, 255 * alpha))
		render.DrawBeam(cubictwo, self.EndPos, 6, texcoord, texcoord + nlen / 128, Color(226, 196, 25, 255 * alpha))
	end
	render.DrawBeam(self.StartPos, cubicone, 27, texcoord, texcoord + nlen / 128, Color(228, 216, 58, 170 * alpha))
	render.DrawBeam(cubicone, cubictwo, 27, texcoord, texcoord + nlen / 128, Color(228, 216, 58, 170 * alpha))
	render.DrawBeam(cubictwo, self.EndPos, 27, texcoord, texcoord + nlen / 128, Color(58, 83, 228, 170 * alpha))
