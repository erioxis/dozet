...
function EFFECT:Render()
	...
	render.DrawSprite(self.StartPos, 130, 130, Color(38, 172, 255, self.Alpha))
	render.DrawSprite(self.EndPos, 50, 50, Color(163, 212, 255, self.Alpha))
end
