...
trinket = GM:AddTrinket("Cursed Trinket", "cursedtrinket", false, supveles, supweles, 4, "Всегда меняется(+10% К сопротивляемости урону),+100% К получаемому опыту,-2% К множителю,после получения урона получаешь 10 проклятья\nEver Change(-10% damage taken),+100% XP mul,-2% Points MUL,curse you for 10 secs ")
GM:AddSkillModifier(trinket, SKILLMOD_MELEE_DAMAGE_TAKEN_MUL, -0.10)
