...
killicon.Add("weapon_zs_medstation", "zombiesurvival/killicons/weapon_zs_repairfield")
...
net.Receive("zs_pl_kill_pl", function(length)
	...
	if victim:IsValid() and attacker:IsValid() then
		...
		GAMEMODE:TopNotify((attacker:GetZombieClassTable().Boss and attacker:GetActiveWeapon() and {killicon = (attacker:GetActiveWeapon():GetClass() or"weapon_zs_crow" )} or ""),(attacker:GetZombieClassTable().Boss and COLOR_RED or color_white),(attacker:GetZombieClassTable().Boss and attacker:Name() or attacker), " ", color_white,{killicon = inflictor, headshot = headshot}, " ", victim)
	end
end)
