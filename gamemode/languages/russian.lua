...
LANGUAGE.wep_d_barricadekit = "Готовое универсальное устройство для размещение досок. Автоматически прикрепляет доску, а затем надежно прикрепляет ее практически к любой поверхности. Используйте ПКМ, чтобы закрепить доски. Используйте ЛКМ или R, чтобы вращать доску, но если вам не нравится где размещена доска удерживайте SHIFT смотря на доску чтобы убрать её. Призрак доски показывает вам, является ли место действительным или нет."
