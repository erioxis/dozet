...
LANGUAGE.skill_schance_d1 = "Save from letal hit(Only once per wave)\n"
...
LANGUAGE.skill_mobile_d1 = "Your starting with random weapon\n"
LANGUAGE.skill_mobile_d2 = "-5 Luck"
