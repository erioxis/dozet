...
LANGUAGE.wep_d_m6	= "Very Strange weapon,have some souls,upgrade per kill(if you don't kill zombie every 60 sec upgrade has dismantled)...."
...
LANGUAGE.wep_d_m_damage = "Use ATTACK to shot focused energy of blood.\nUse SECONDARY ATTACK to regenerate some blood armor and get buff for 20 secs,and take off 20 curses."
