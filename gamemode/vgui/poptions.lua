function MakepOptions()
	...
	list:AddItem(check)
	check = vgui.Create("DCheckBoxLabel", Window)
	check:SetText("Don't Show attack is unable")
	...
	dropdown.OnSelect = function(me, index, value, data)
		RunConsoleCommand("zs_healthtargetdisplay", value == "Health amount" and 1 or 2)
	end
	...
	list:AddItem(slider)
	check = vgui.Create("DCheckBoxLabel", Window)
	check:SetText(""..translate.Get("op_blockposition"))
	check:SetConVar("zs_blockposition")
	check:SizeToContents()
	list:AddItem(check)
	slider = vgui.Create("DNumSlider", Window)
	slider:SetDecimals(0)
	slider:SetMinMax(0, 3000)
	slider:SetConVar("zs_x_block_func")
	slider:SetText("X align for block")
	slider:SizeToContents()
	list:AddItem(slider)
	slider = vgui.Create("DNumSlider", Window)
	slider:SetDecimals(0)
	...
	slider:SetDecimals(0)
	slider:SetMinMax(0, 255)
	slider:SetConVar("zs_rhealth")
	slider:SetText("RED color for health")
	slider:SizeToContents()
	list:AddItem(slider)
	slider = vgui.Create("DNumSlider", Window)
	slider:SetDecimals(0)
	slider:SetMinMax(0, 255)
	slider:SetConVar("zs_ghealth")
	slider:SetText("GREEN color for health")
	slider:SizeToContents()
	list:AddItem(slider)
	slider = vgui.Create("DNumSlider", Window)
	slider:SetDecimals(0)
	slider:SetMinMax(0, 255)
	slider:SetConVar("zs_bhealth")
	slider:SetText("BLUE color for health")
	slider:SizeToContents()
	list:AddItem(slider)
	slider = vgui.Create("DNumSlider", Window)
	slider:SetDecimals(0)
	slider:SetMinMax(0, 255)
	slider:SetConVar("zs_rblood")
	slider:SetText("RED color for blood armor")
	slider:SizeToContents()
	list:AddItem(slider)
	slider = vgui.Create("DNumSlider", Window)
	slider:SetDecimals(0)
	slider:SetMinMax(0, 255)
	slider:SetConVar("zs_gblood")
	slider:SetText("GREEN color for blood armor")
	slider:SizeToContents()
	list:AddItem(slider)
	slider = vgui.Create("DNumSlider", Window)
	slider:SetDecimals(0)
	slider:SetMinMax(0, 255)
	slider:SetConVar("zs_bblood")
	slider:SetText("BLUE color for blood armor")
	slider:SizeToContents()
	list:AddItem(slider)
