...
function PANEL:Paint( w, h )
	...
	derma.SkinHook( "Paint", "Button_fix", self, w, h )
...
function PANEL:UpdateColours( skin )
	...
	return self:SetTextStyleColor(Color(204, 204, 204, 220))
...
local PANEL = derma.DefineControl( "DButton_fix", "A standard Button (color changed)", PANEL, "DLabel" )
...
derma.DefineControl( "Button_fix", "Backwards Compatibility", PANEL, "DLabel" )
