...
GM:AddPointShopItem("scrap100",				ITEMCAT_TOOLS,			500,				nil,							"Scrap x100",							"Scrap but is have x100.",					"ammo_scrap",						function(pl) pl:GiveAmmo(100, "Scrap", true) end)
GM:AddPointShopItem("scrap900",				ITEMCAT_TOOLS,			3000,				nil,							"Scrap x900",							"Scrap but is have x100.",					"ammo_scrap",						function(pl) pl:GiveAmmo(900, "Scrap", true) end)
