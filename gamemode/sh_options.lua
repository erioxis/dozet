...
GM:AddPointShopItem("pistolammo",		ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_pistol").." (x24)",				nil,									"ammo_pistol",						function(pl) pl:GiveAmmo(25, "pistol", true) end)
GM:AddPointShopItem("shotgunammo",		ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_buckshot").." (x14)",				nil,									"ammo_shotgun",						function(pl) pl:GiveAmmo(14, "buckshot", true) end)
GM:AddPointShopItem("smgammo",			ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_smg").." (x55)",					nil,									"ammo_smg",							function(pl) pl:GiveAmmo(55, "smg1", true) end)
GM:AddPointShopItem("rifleammo",		ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_rifle").." (x12)",					nil,									"ammo_rifle",						function(pl) pl:GiveAmmo(12, "357", true) end)
GM:AddPointShopItem("crossbowammo",		ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_bolts").." (x8)",				nil,									"ammo_bolts",						function(pl) pl:GiveAmmo(8,	"XBowBolt",	true) end)
GM:AddPointShopItem("assaultrifleammo",	ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_assaultrifle").." (x46)",		nil,									"ammo_assault",						function(pl) pl:GiveAmmo(46, "ar2", true) end)
GM:AddPointShopItem("pulseammo",		ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_pulseshots").." (x35)",				nil,									"ammo_pulse",						function(pl) pl:GiveAmmo(35, "pulse", true) end)
GM:AddPointShopItem("impactmine",		ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_explosives").." (x5)",					nil,									"ammo_explosive",					function(pl) pl:GiveAmmo(5, "impactmine", true) end)
GM:AddPointShopItem("chemical",			ITEMCAT_AMMO,			8,				nil,							translate.Get("ammo_chemicals").." (x35)",			nil,									"ammo_chemical",					function(pl) pl:GiveAmmo(35, "chemical", true) end)
item =
