...
GM:AddPointShopItem("v1altbranch",		ITEMCAT_GUNS,			65,			"weapon_zs_marksman")
-- Tier 3
...
GM:AddPointShopItem("rlaunch",			ITEMCAT_GUNS,			150,			"weapon_zs_rlauncher")
-- Tier 4
...
GM:AddPointShopItem("rail_gun",			ITEMCAT_GUNS,			400,			"weapon_zs_rgun")
-- Tier 5
