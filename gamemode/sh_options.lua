...
GM:AddPointShopItem("jackhammer",		ITEMCAT_GUNS,			300,			"weapon_zs_jackhammer")
...
GM:AddPointShopItem("pulserifle",		ITEMCAT_GUNS,			700,			"weapon_zs_pulserifle")
GM:AddPointShopItem("spinfusor",		ITEMCAT_GUNS,			700,			"weapon_zs_spinfusor")
GM:AddPointShopItem("broadside",		ITEMCAT_GUNS,			700,			"weapon_zs_broadside")
...
GM:AddPointShopItem("kongol",			ITEMCAT_MELEE,			135,			"weapon_zs_kongolaxe")
...
GM:AddPointShopItem("scrap100",				ITEMCAT_TOOLS,			300,				nil,							"Scrap x100",							"Scrap but is have x100.",					"ammo_scrap",						function(pl) pl:GiveAmmo(100, "Scrap", true) end)
GM:AddPointShopItem("scrap900",				ITEMCAT_TOOLS,			1200,				nil,							"Scrap x900",							"Scrap but is have x100.",					"ammo_scrap",						function(pl) pl:GiveAmmo(900, "Scrap", true) end)
...
-- Boss Mutagen
GM:AddMutationItem("m_zombie_health2", ""..translate.Get("zshop_godestzomb"), ""..translate.Get("zshop_godestzomb2"), ITEMCAT_MUTATIONS_BOSS, 2000, nil, function(pl) pl.m_Zombie_GodyHealth = true end, "models/items/healthkit.mdl")
