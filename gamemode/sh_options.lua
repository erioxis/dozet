...
GM:AddPointShopItem("v1altbranch",		ITEMCAT_GUNS,			600,			"weapon_zs_marksman")
...
GM:AddPointShopItem("scar",				ITEMCAT_GUNS,			600,			"weapon_zs_scar")
GM:AddPointShopItem("juggernaut",		ITEMCAT_GUNS,		    600,			"weapon_zs_juggernaut")
GM:AddPointShopItem("zenith",		ITEMCAT_GUNS,			600,			"weapon_zs_zenith")
-- Tier 5
GM:AddPointShopItem("piercer",			ITEMCAT_GUNS,			1700,				"weapon_zs_piercer")
GM:AddPointShopItem("slugrifle",		ITEMCAT_GUNS,			1700,			"weapon_zs_slugrifle")
GM:AddPointShopItem("gluon",			ITEMCAT_GUNS,			1700,			"weapon_zs_gluon")
GM:AddPointShopItem("novacolt",			ITEMCAT_GUNS,			1700,			"weapon_zs_novacolt")
GM:AddPointShopItem("bulwark",			ITEMCAT_GUNS,		   1700,			"weapon_zs_bulwark")
GM:AddPointShopItem("colossus",			ITEMCAT_GUNS,			1700,			"weapon_zs_colossus")
GM:AddPointShopItem("renegade",			ITEMCAT_GUNS,			1700,			"weapon_zs_renegade")
GM:AddPointShopItem("crossbow",			ITEMCAT_GUNS,			1700,			"weapon_zs_crossbow")
GM:AddPointShopItem("pulserifle",		ITEMCAT_GUNS,			1700,			"weapon_zs_pulserifle")
GM:AddPointShopItem("spinfusor",		ITEMCAT_GUNS,			1700,			"weapon_zs_spinfusor")
GM:AddPointShopItem("broadside",		ITEMCAT_GUNS,			1700,			"weapon_zs_broadside")
GM:AddPointShopItem("smelter",			ITEMCAT_GUNS,			1700,			"weapon_zs_smelter")
GM:AddPointShopItem("hyena",			ITEMCAT_GUNS,			1700,				"weapon_zs_hyena")
GM:AddPointShopItem("boomstick",		ITEMCAT_GUNS,			1700,			"weapon_zs_boomstick")
GM:AddPointShopItem("bulldog",		ITEMCAT_GUNS,			1700,			"weapon_zs_bulldog")
-- Tier 6 beta
GM:AddPointShopItem("zeus",				ITEMCAT_GUNS,			5000,			"weapon_zs_zeus")
GM:AddPointShopItem("classixg",			ITEMCAT_GUNS,			5000,			"weapon_zs_classic")
GM:AddPointShopItem("plasmk",			ITEMCAT_GUNS,			5000,			"weapon_zs_plasmatik")
GM:AddPointShopItem("deathdlrs",		ITEMCAT_GUNS,			5000,			"weapon_zs_deathdealers")
GM:AddPointShopItem("rlaucnher",		ITEMCAT_GUNS,			5000,			"weapon_zs_rocket_launcher")
GM:AddPointShopItem("biotic_grl",		ITEMCAT_GUNS,			5000,			"weapon_zs_biotic_grl")
GM:AddPointShopItem("smorning",		ITEMCAT_GUNS,			5000,			"weapon_zs_smorning")
GM:AddPointShopItem("drill",		ITEMCAT_GUNS,			5000,			"weapon_zs_drill")
-- Tier 7
GM:AddPointShopItem("sacredhh",			ITEMCAT_GUNS,			8000,			"weapon_zs_m6")
GM:AddPointShopItem("gaysseagle",   	ITEMCAT_GUNS,			8000,			"weapon_zs_gaeagle")
GM:AddPointShopItem("doomstick",   	ITEMCAT_GUNS,			8000,			"weapon_zs_doomstick")
GM:AddPointShopItem("zenith2",		ITEMCAT_GUNS,			8000,			"weapon_zs_zenithmega")
GM:AddPointShopItem("flamethrower",		ITEMCAT_GUNS,			8000,			"weapon_zs_flamethrower")
...
GM:AddPointShopItem("pw7",			ITEMCAT_MELEE,			6500,			"weapon_zs_powerfists_t7")
-- Tier 7
GM:AddPointShopItem("speed",			ITEMCAT_MELEE,			80600,			"weapon_zs_speed")
GM:AddPointShopItem("xouryc",			ITEMCAT_MELEE,			8000,			"weapon_zs_loy")
GM:AddPointShopItem("murasama",			ITEMCAT_MELEE,			8000,			"weapon_zs_murasama")
-- Super Trinkets ------------------------------------------------------------------------------------------------------------------------------------------------
